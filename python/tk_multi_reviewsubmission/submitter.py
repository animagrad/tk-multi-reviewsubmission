...
class Submitter(object):
    ...
    def submit_version(self, path_to_frames, path_to_movie, thumbnail_path, sg_publishes,
        ...
        # AMG code 
        print '>> submit_version...'
        print 'sg_path_to_frames =', path_to_frames
        
        # correct path_to_frames to AMG path format
        correct_path = path_to_frames.replace('\\', '/')
        correct_path = '//' + correct_path.lstrip('/')
        path_to_frames = correct_path
        print 'correct_path =', correct_path
        
        print 'path_to_movie =', path_to_movie

        # correct path_to_movie to AMG path format
        correct_path = path_to_movie.replace('\\', '/')
        correct_path = '//' + correct_path.lstrip('/')
        path_to_movie = correct_path
        print 'correct_path =', correct_path
